    ...
    render() {
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                            ...
                            {/* 오늘의 픽 제목 */}
                            <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">오늘의 픽</h2>
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                            ...
                            {/* TOE BOX 제목 */}
                            <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">TOE BOX</h2>
        ...
        <section class="page-section bg-primary text-white mb-0" id="about">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ms-autor"><p class="lead">
                        이름 : 한상희 <br/>
                        생년월일 : 1999.07.19<br/>
